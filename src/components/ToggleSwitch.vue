  ...
  computed: {
    ...
    labelStyle() {
      return {
        ...
        borderColor: this.defaultOptions.layout.noBorder
          ? "transparent"
          : this.defaultOptions.layout.borderColor,
  ...
  methods: {
    toggle(event) {
      if (!this.defaultOptions.config.disabled) {
        ...
        this.$emit(
          "update:modelValue",
          event.target.id.replace(this.group, "")
        );
        this.$emit("input", this.selectedItem);
        this.$emit("change", {
      ...
      return {
        ...
        backgroundColor:
          backgroundColor !== undefined
            ? backgroundColor
            : this.defaultOptions.layout.selectedBackgroundColor,
        color:
          color !== undefined
            ? color
            : this.defaultOptions.layout.selectedColor,
      };
    },
